    ...
    return (
        <div className='h-screen flex items-center justify-between p-8'>
            ...
            <div className='w-full lg:w-1/2 flex flex-col gap-4'>
                ...
                <SignIn.Root>
                    <Clerk.Connection name='google' className='bg-white font-bold rounded-full p-2 text-black w-72 flex items-center justify-center gap-2'>
                    ...
                    <Clerk.Connection name='apple' className='bg-white p-2  text-black font-bold rounded-full flex items-center justify-center gap-2 w-72'>
