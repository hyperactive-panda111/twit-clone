      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        ...
        <SignUp.Root>
          <SignUp.Step name='start' className='flex flex-col gap-4'>
            <Clerk.Connection name='google' className='bg-white rounded-full p-2 text-black w-72 font-bold flex items-center justify-center gap-2'>
            ...
            <Clerk.Connection name='apple' className='bg-white p-2 text-black rounded-full font-bold flex items-center justify-center gap-2 w-72'>
          ...
          <Link href={'/sign-in'} className='bg-iconBlue rounded-full text-white font-bold w-72 text-center p-2'>Already have an account?</Link>
